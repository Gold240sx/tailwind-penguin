...
const WithMinimalMenuIconReact = (
  <Menu as="div" className="relative inline-block text-left">
    <div>
...
`
  ...
  codePreview: WithIconsReact
}

const WithMinimalMenuIcon: ComponentData = {
  componentName: 'With Minimal Menu Icon',
  tags: ['dropdown', 'select', 'input', 'menu', 'options'],
  library: 'Tailwind',
  type: 'dropdown',
  favorite: false,
  darkMode: false,
...
import { EllipsisVerticalIcon } from '@heroicons/vue/20/solid'
  ...
  functions: {
    React: `function classNames(...classes: string[]) {
  return classes.filter(Boolean).join(' ')
}`
  },
  installInstructions: TailwindInstall(
...
<div class="relative inline-block text-left">
  <div>
    <button type="button" class="flex items-center rounded-full bg-gray-100 text-gray-400 hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-100" id="menu-button" aria-expanded="true" aria-haspopup="true">
...
`
  ...
  codePreview: WithMinimalMenuIconReact
}

const WithSimpleHeader: ComponentData = {
  componentName: 'With Simple Header',
  tags: ['dropdown', 'select', 'input', 'menu', 'options'],
  library: 'Tailwind',
  type: 'dropdown',
  favorite: false,
...
`
  ...
  codePreview: WithSimpleHeaderReact
}
