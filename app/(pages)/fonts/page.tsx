...
export default function Icons() {
	...
	const [libFilters, setLibFilters] = useState(["Goole Fonts", "CDNFonts"])

	return (
		<>
			<h1 className="text-4xl text-center pb-10">Icon Collections</h1>
			<div className="flex items-start justify-between w-full h-auto  gap-4 min-h-screen">
				...
				<div className="flex flex-col gap-6 w-full">
					<FilterBox filters={libFilters} setFilters={setLibFilters} library="fonts" />
					<section
